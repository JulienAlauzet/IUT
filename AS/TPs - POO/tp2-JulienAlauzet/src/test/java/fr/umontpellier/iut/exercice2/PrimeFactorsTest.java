...
class PrimeFactorsTest {
    ...
    @Test
    public void fifteen_should_give_3_and_5() {
        assertEquals(primeFactors.computeFactors(15), list(3, 5));
    }

    @Test
    public void twentyfive_should_give_5_and_5() {
        assertEquals(primeFactors.computeFactors(25), list(5, 5));
    }
