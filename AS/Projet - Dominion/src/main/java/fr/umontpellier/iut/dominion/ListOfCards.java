...
public class ListOfCards extends ArrayList<Card> {
    ...
    public Card remove(String cardName) {
        ...
        Card carteRetiree = getCard(cardName);
    ...
    //METHODE AJOUTE JADE, permet de mettre une liste de carte dans la défausse d'un joueur
    public void putInDiscard(Player p){
        for (Card c: this) {
            p.discardCard(c);
        }
    }
